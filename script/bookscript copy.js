...
// const firebaseAppScript = createAndAppendElement(headElement, 'script', {
//   type: 'text/javascript',
//   src: 'https://www.gstatic.com/firebasejs/10.0.0/firebase-app-compat.js'
// });

// const firebaseAuthScript = createAndAppendElement(headElement, 'script', {
//   type: 'text/javascript',
...
// Your code to run when all scripts are loaded
//   console.log('All scripts have loaded, you can now perform your tasks.');
// }

// Track the number of loaded scripts
let loadedScriptCount = 0;

// Load all scripts and check if they are loaded
scripts.forEach((script) => {
  const scriptElement = createAndAppendScript(script.src);
...
//   if (firebaseAppLoaded && firebaseAuthLoaded) {
//     initializeFirebase();
//   }
// }
